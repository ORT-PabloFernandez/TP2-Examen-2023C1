...
- /api/sales
  ...
  2.- /api/sales/PurchaseMethod/:purchaseMethod

  3.- api/sales/Customer/:email/sales

  4.- api/sales/Satisfaction/:satisfactionLevel/Customers

  5.- api/sales/StoreLocation/:storeLocation/Amount
